...
import com.example.progect.databinding.ActivityTngListBinding

class TNGFragment : BaseFragment<ActivityTngListBinding>() {
    override fun createViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ): ActivityTngListBinding = ActivityTngListBinding.inflate(inflater, container, false)


    override fun ActivityTngListBinding.onBindView(saveInstanceState: Bundle?) {
        strelochkaTNG.setOnClickListener {
