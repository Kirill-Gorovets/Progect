...
import com.example.progect.databinding.ActivityAcListBinding


class ACFragment : BaseFragment<ActivityAcListBinding>() {
    override fun createViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ): ActivityAcListBinding = ActivityAcListBinding.inflate(inflater, container, false)

    override fun ActivityAcListBinding.onBindView(saveInstanceState: Bundle?) {
