...
import com.example.progect.databinding.ActivityXtListBinding

class XTFragment : BaseFragment<ActivityXtListBinding>() {
    override fun createViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ): ActivityXtListBinding = ActivityXtListBinding.inflate(inflater, container, false)


    override fun ActivityXtListBinding.onBindView(saveInstanceState: Bundle?) {
        strelochkaXT.setOnClickListener {
